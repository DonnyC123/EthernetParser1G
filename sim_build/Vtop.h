...
class alignas(VL_CACHE_LINE_BYTES) Vtop VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vtop_crc_pkg* const __PVT__crc_pkg;
    Vtop_mac_if_pkg* const __PVT__mac_if_pkg;
    Vtop_rgmii_if* const __PVT__rx_mac_top_test__DOT__rgmii_if_internal;
    Vtop_gmii_if* const __PVT__rx_mac_top_test__DOT__rx_mac_top_inst__DOT__gmii_rx_if;
